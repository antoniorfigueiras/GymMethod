...
?>
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto btn-adicionar-carrinho" href="<?php echo \yii\helpers\Url::to(["/carrinho/add"])?>">Adicionar ao carrinho</a></div>
                            </div>
                        </div>